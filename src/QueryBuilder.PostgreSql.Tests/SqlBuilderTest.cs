using System;
using Xunit;
using Tolitech.CodeGenerator.Infrastructure.Data.QueryBuilder.PostgreSql.Tests.Domain.Entities;

namespace Tolitech.CodeGenerator.Infrastructure.Data.QueryBuilder.PostgreSql.Tests
{
    public class SqlBuilderTest
    {
        ...
        public void SqlBuilder_SelectAsterisk_Valid()
        {
            ...
            string expected = "select * from \"public\".\"Person\" where \"PersonId\" = @PersonId and \"Age\" > @Age;";
